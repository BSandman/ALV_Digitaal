...
class PipelineSetupTests(unittest.TestCase):
    ...
    def test_existing_tag_must_equal_recorded_release_sha(self) -> None:
        metadata = pipeline_guard.SprintMetadata(
            sprint=14, branch="agent/sprint-14-veilige-activatie",
            base_sha="b" * 40,
    ...
    def test_live_repository_safety_requires_exact_off_and_disabled(self) -> None:
        ...
        for kwargs in (
            {"repository_variable": "", "workflow_state": "disabled_manually"},
            {"repository_variable": "OFF", "workflow_state": "disabled_manually"},
            {"repository_variable": "off", "workflow_state": "active"},
        ):
